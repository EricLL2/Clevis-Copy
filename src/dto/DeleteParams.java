...
/** This class is created to hold the parameters of the delete command.
 ...
 */
public class DeleteParams extends NameParams {
    /**
     * The default constructor for the class {@code DeleteParams}.
     *
     * @param n: the name of the shape given by the user.
     */
    public DeleteParams(String n){
        super(n);
    }
}
